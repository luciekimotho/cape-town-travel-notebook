...
export interface Place { id: string; name: string; stampKind?: StampDesign; address?: string; notes?: string; googleMapsUrl?: string; wantToVisit: boolean; seeded?: boolean; createdAt: string; updatedAt: string }
...
export interface ActivityTemplate { id: string; name: string; stampKind?: StampDesign; description: string; stops: ActivityTemplateStop[]; seeded: boolean; createdAt: string; updatedAt: string }
...
export interface TravelStamp { id: string; itineraryItemId?: string; placeName: string; stampKind?: StampDesign; visitDate: string; detached: boolean; createdAt: string }
